unit CodeSmells_Experts_MenuWizard;
...
uses
  SysUtils,
  Menus,
  ToolsAPI, CodeSmells_Entities_FartOptions, CodeSmells_Entities_FartTypes;
...
begin
  ...
  FIniPath := {TPath.}ChangeFileExt(LPathValue, '.ini');
end;
